...
function adivinaElNumero() {
  while (intentos < intentosMaximos) {
    const intento = prompt(`Intento ${intentos + 1}/${intentosMaximos}: Adivina el número (entre 1 y 100):`);
  ...
  alert(`¡Agotaste tus ${intentosMaximos} intentos! El número era ${numeroAleatorio}.`);
}
